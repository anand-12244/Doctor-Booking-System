...
import {
  ...
  Modal, ScrollView, StatusBar, Pressable, Dimensions,
} from 'react-native';
...
export default function Navbar({ navigation, currentRoute }) {
  ...
  const avatarUri = userData?.image
          ...
          <View style={styles.drawerHeader}>
            ...
            >
              <View style={styles.closeIcon}>
                ...
                <View style={[styles.closeLine, styles.closeLineAbs, { transform: [{ rotate: '-45deg' }] }]} />
              </View>
            </TouchableOpacity>
          </View>
              ...
              {NAV_LINKS.map(({ label, route }) => {
                ...
                return (
                  ...
                  >
                    ...
                    <Text style={[styles.linkArrow, active && { color: PRIMARY }]}>›</Text>
                  </TouchableOpacity>
                );
              })}
            </View>
...
const styles = StyleSheet.create({
  ...
  closeIcon: { width: 18, height: 18, position: 'relative', alignItems: 'center', justifyContent: 'center' },
  closeLine: {
  ...
  profileArrowText: { fontSize: 18, color: PRIMARY, fontWeight: '600', lineHeight: 22 },
