...
const FavouritesScreen = ({ navigation }) => {
  ...
  const { favourites, toggleFavourite, isFavourite } = useContext(FavouritesContext);
          ...
          favDoctors.map(doc => (
            ...
            >
              ...
              <View style={s.imgWrap}>
                <Image source={{ uri: doc.image }} style={s.img} resizeMode="contain" />
              </View>
              ...
              <View style={s.info}>
                ...
                <Text style={s.degree}>{doc.degree} • {doc.experience}</Text>
              </View>
...
const s = StyleSheet.create({
  ...
  browseBtn: {
    backgroundColor: PRIMARY, paddingHorizontal: 28,
